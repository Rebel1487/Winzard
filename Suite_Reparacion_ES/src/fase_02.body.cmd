::SRC fase_02.body.cmd | Cuerpo de arranque de la fase 02 (Task 1.3, Req 2.1/14.1/14.3).
...
call :bigbanner
echo(
echo  %DIM%Fase suelta 02 - Limpieza inicial%R%
echo(
call :env_validate
...
call :phase "02" "Limpieza inicial" "Borra temporales, papelera y caches para dar aire al disco."

...
function Get-PhaseFileName {
    ...
    $names = @{
        '00' = 'Fase_00_Diagnostico_y_triage.bat'
        '01' = 'Fase_01_Punto_de_restauracion.bat'
        '02' = 'Fase_02_Limpieza_inicial.bat'
        '03' = 'Fase_03_CHKDSK.bat'
        '04' = 'Fase_04_Optimizacion_de_disco.bat'
        '05' = 'Fase_05_DISM.bat'
        '06' = 'Fase_06_SFC_y_verificacion.bat'
        '07' = 'Fase_07_Reparar_WMI.bat'
        '08' = 'Fase_08_Apps_de_Store_e_Inicio.bat'
        '09' = 'Fase_09_Busqueda_y_caches.bat'
        '10' = 'Fase_10_Certificados_y_hora.bat'
        '11' = 'Fase_11_Red.bat'
        '12' = 'Fase_12_Directivas_GPO.bat'
        '13' = 'Fase_13_Windows_Update.bat'
        '14' = 'Fase_14_Winget.bat'
        '15' = 'Fase_15_Dispositivos.bat'
...
function Get-AllTargets {
    ...
    $targets.Add([pscustomobject]@{
        Name     = 'Suite_Reparacion_TodoEnUno.bat'
